...
//	out.println("삭제하기 위해 입력한 비밀번호의 글자수: " + vo.getPassword().length());
//	out.println("삭제할 글의 비밀번호 글자수: " + original.getPassword().trim().length());

//	삭제할 글의 비밀번호와 삭제하기 위해 입력한 비밀번호를 비교한다.
	out.println("<script>");
