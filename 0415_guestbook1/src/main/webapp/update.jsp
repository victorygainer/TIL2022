	...
	<form action="updateOK.jsp" method="post">
		<table width="600" align="center" border="1" cellpadding="5" cellspacing="0">
			...
			<tr>
				<th>작성일</th>
				<td>
					<fmt:formatDate value="${vo.writeDate}" pattern="yyyy년 MM월 dd일 HH시 mm분 ss초"/>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea id="memo" rows="10" name="memo" style="resize: none; width: 98%;">${vo.memo}</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
