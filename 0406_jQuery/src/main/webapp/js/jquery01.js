...
//	$('#list').css('backgroundColor', 'skyblue'); // backgroundColor: javascript 스타일
//	$('#list').css('background-color', 'chocolate'); // background-color: html 스타일
//	$('#list').css('background', 'hotpink'); // background: 단축 속성
...
//	document.getElementsByTagName('li')[1].style.backgroundColor = 'chocolate';
	...
	$('#list > li').eq(1).css('backgroundColor', 'hotpink');
