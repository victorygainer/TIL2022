...
//	static을 붙여서 선언한 변수나 메소드는 클래스의 객체를 생성하지 않고 클래스 이름에 "."을 찍어
//	바로 접근할 수 있다.
...
//	3과목 점수와 이름을 넘겨받아 총점과 평균을 계산한 후 초기화시키는 생성자
	public ScoreVO(String name, int java, int jsp, int spring) {
		idx = ++count; // 객체가 생성될 때 마다 idx를 1씩 증가시킨다.
		this.name = name;
		this.java = java;
		this.jsp = jsp;
		this.spring = spring;
