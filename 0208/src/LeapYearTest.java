...
//		논리값을 기억하는 변수나 리턴타입이 논리값인 메소드의 이름은 "is"로 시작하는게 관행이다.
...
//		삼항 연산자(?:)
//		삼항 연산자는 조건식을 비교한 후 참이나 거짓일 경우 실행할 문장이 각각 1문장 일때 사용하면 편리하다.
//		형식: 조건식 ? 참일 때 실행할 문장 : 거짓일 때 실행할 문장
		
		System.out.println(year + "년은 " + (isLeapYear ? "윤" : "평") + "년입니다.");
		System.out.printf("%d년은 %s년입니다.", year, isLeapYear ? "윤" : "평");
